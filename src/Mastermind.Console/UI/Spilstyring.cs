...
namespace Mastermind.Konsol.UI
{
    public class Spilstyring
    {
        ...
        private readonly IStatistikStore _statsStore;
        /// <summary>
        ...
        public Spilstyring(
            ...
            KonsolMenu menu,
            Statistik? statistik,
            IStatistikStore? statistikStore)
        {
            ...
            _statsStore = statistikStore ?? throw new ArgumentNullException(nameof(statistikStore));
        }
        /// <summary>
        ...
        public void SingularRunde()
        {
            ...
            while (forsøg < _options.maxForsøg && !vundet)
            {
                ...
                if (feedback.Black == _options.længde)
                {
                    ...
                    _statsStore.Append(new GameResult(DateTime.UtcNow, true, forsøg));
                    return;
                }
            }
            ...
            _statistik.Render(_options);
            _statsStore.Append(new GameResult(DateTime.UtcNow, false, _options.maxForsøg));
        }
        /// <summary>
